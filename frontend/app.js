/* =============================================
   app.js – Agricultural Disease Scan Frontend JavaScript
   ============================================= */
...
const API_BASE_URL = (window.location.hostname === "localhost" || window.location.hostname === "127.0.0.1")
  ? "http://localhost:8000"
  : "https://agricultural-disease-scan.onrender.com";
...
document.getElementById("saveReportBtn").addEventListener("click", () => {
  ...
  const report = `Agricultural Disease Scan – Disease Report
============================
...
============================
Generated by Agricultural Disease Scan
...
`;
  ...
  a.href = url;
  a.download = `agritreat_report_${Date.now()}.txt`;
  a.click();
      ...
      <div id="chatWidget" class="chat-widget">
        <div id="chatWindow" class="chat-window hidden">
          <div class="chat-header">
            <span data-i18n="chat.title">🌿 AgriDisease Bot</span>
